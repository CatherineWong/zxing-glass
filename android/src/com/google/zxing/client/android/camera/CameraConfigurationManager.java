...
final class CameraConfigurationManager {
  ...
  /* MANUALLY ADDED TO FORCE GLASS PARAMETERS*/
  public void initializeGlassCamera(Camera camera){ //Added to manually force glass parameters
  ...
  void setDesiredCameraParameters(Camera camera, boolean safeMode) {
    ...
    initializeGlassCamera(camera); //Initialize glass
